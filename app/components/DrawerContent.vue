...
<GridLayout rows="auto, *" class="nt-drawer__content">
            ...
            <ScrollView row="1" class="nt-drawer__body">
                <StackLayout>
                    ...
                    <GridLayout columns="auto, *" :class="'nt-drawer__list-item' + (selectedPage === 'Question' ? ' -selected': '')" @tap="onNavigationItemTap(Question)">
                        <Label col="0" text.decode="&#xf02e;" class="nt-icon fas"></Label>
                        <Label col="1" text="Questions" class="p-r-10"></Label>
                    </GridLayout>

                    <GridLayout columns="auto, *" :class="'nt-drawer__list-item' + (selectedPage === 'Maps' ? ' -selected': '')" @tap="onNavigationItemTap(Maps)">
                        <Label col="0" text.decode="&#xf02e;" class="nt-icon fas"></Label>
                        <Label col="1" text="Maps" class="p-r-10"></Label>
                    </GridLayout>
